    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="提醒名称" prop="zhongyaotixingName">
                       <el-input v-model="ruleForm.zhongyaotixingName"
                                 placeholder="提醒名称" clearable  :readonly="ro.zhongyaotixingName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="提醒名称" prop="zhongyaotixingName">
                           <el-input v-model="ruleForm.zhongyaotixingName"
                                     placeholder="提醒名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="提醒类型" prop="zhongyaotixingTypes">
                        <el-select v-model="ruleForm.zhongyaotixingTypes" :disabled="ro.zhongyaotixingTypes" placeholder="请选择提醒类型">
                            <el-option
                                v-for="(item,index) in zhongyaotixingTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="提醒类型" prop="zhongyaotixingValue">
                        <el-input v-model="ruleForm.zhongyaotixingValue"
                            placeholder="提醒类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="提醒时间" prop="anpaiTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.anpaiTime" label="提醒时间" prop="anpaiTime">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="提醒详情" prop="zhongyaotixingContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.zhongyaotixingContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.zhongyaotixingContent" label="提醒详情" prop="zhongyaotixingContent">
                            <span v-html="ruleForm.zhongyaotixingContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    zhongyaotixingName: false,
                    zhongyaotixingTypes: false,
                    anpaiTime: false,
                    zhongyaotixingContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
                    ...
                    zhongyaotixingTypes: '',
                    anpaiTime: '',
                    zhongyaotixingContent: '',
                    insertTime: '',
                },
                zhongyaotixingTypesOptions : [],
                yonghuOptions : [],
                rules: {
                   yonghuId: [
                   ...
                   zhongyaotixingTypes: [
                              { required: true, message: '提醒类型不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   zhongyaotixingContent: [
                              { required: true, message: '提醒详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhongyaotixing_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.zhongyaotixingTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`zhongyaotixing/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.zhongyaotixingCrossAddOrUpdateFlag = false;
                                        this.parent.search();
