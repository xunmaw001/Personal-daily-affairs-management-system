    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="消费名称" prop="xiaofeijiluName">
                       <el-input v-model="ruleForm.xiaofeijiluName"
                                 placeholder="消费名称" clearable  :readonly="ro.xiaofeijiluName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="消费名称" prop="xiaofeijiluName">
                           <el-input v-model="ruleForm.xiaofeijiluName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="消费类型" prop="xiaofeijiluTypes">
                        <el-select v-model="ruleForm.xiaofeijiluTypes" :disabled="ro.xiaofeijiluTypes" placeholder="请选择消费类型">
                            <el-option
                                v-for="(item,index) in xiaofeijiluTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="消费类型" prop="xiaofeijiluValue">
                        <el-input v-model="ruleForm.xiaofeijiluValue"
                            placeholder="消费类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="消费时间" prop="anpaiTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.anpaiTime" label="消费时间" prop="anpaiTime">
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="消费详情" prop="xiaofeijiluContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.xiaofeijiluContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.xiaofeijiluContent" label="消费详情" prop="xiaofeijiluContent">
                            <span v-html="ruleForm.xiaofeijiluContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    xiaofeijiluTypes: false,
                    anpaiTime: false,
                    xiaofeiJine: false,
                    xiaofeijiluContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xiaofeijilu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xiaofeijiluTypesOptions = data.data.list;
                    }
                });
