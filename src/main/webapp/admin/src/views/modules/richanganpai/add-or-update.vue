    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="安排名称" prop="richanganpaiName">
                       <el-input v-model="ruleForm.richanganpaiName"
                                 placeholder="安排名称" clearable  :readonly="ro.richanganpaiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="安排名称" prop="richanganpaiName">
                           <el-input v-model="ruleForm.richanganpaiName"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="安排类型" prop="richanganpaiTypes">
                        <el-select v-model="ruleForm.richanganpaiTypes" :disabled="ro.richanganpaiTypes" placeholder="请选择安排类型">
                            <el-option
                                v-for="(item,index) in richanganpaiTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="安排类型" prop="richanganpaiValue">
                        <el-input v-model="ruleForm.richanganpaiValue"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="安排详情" prop="richanganpaiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.richanganpaiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.richanganpaiContent" label="安排详情" prop="richanganpaiContent">
                            <span v-html="ruleForm.richanganpaiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yonghuId: false,
                    richanganpaiName: false,
                    richanganpaiTypes: false,
                    anpaiTime: false,
                    richanganpaiContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    yonghuId: '',
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=richanganpai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.richanganpaiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`richanganpai/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.richanganpaiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
