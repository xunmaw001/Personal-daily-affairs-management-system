...
public class XiaofeijiluView extends XiaofeijiluEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 消费类型的值
		*/
		private String xiaofeijiluValue;
	...
	public XiaofeijiluView(XiaofeijiluEntity xiaofeijiluEntity) {
		try {
			...
			* 获取： 消费类型的值
			*/
			public String getXiaofeijiluValue() {
				return xiaofeijiluValue;
			}
			/**
			* 设置： 消费类型的值
			*/
			public void setXiaofeijiluValue(String xiaofeijiluValue) {
				this.xiaofeijiluValue = xiaofeijiluValue;
			}
